...
<@header css js/>
				...
				<div class="col-md-6 col-md-offset-2">	
					<form method="post" id="wizardForm" name="wizardForm" enctype="multipart/form-data" action="https://molgenis04.target.rug.nl/menu/main/decon-cell/readFile" role="form">	
